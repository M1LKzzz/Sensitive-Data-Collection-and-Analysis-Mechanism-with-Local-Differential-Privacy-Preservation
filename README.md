...
项目介绍： 本项目针对多源复杂异构数据维度高，计算任务复杂等特点，对多阶段的局部最优扰动机制设计方法展开系统和深入的研究，突破现有技术全局最优求解难，聚焦高维数据扭曲难以解决的关键技术难点，研究支撑拓展差分隐私保护机制的新一代设计方法论与机制，实现对多源异构数据、复杂数据分析任务以及多态数据的高效隐私保护，以显著提升数据分析的准确度与隐私保护强度。
